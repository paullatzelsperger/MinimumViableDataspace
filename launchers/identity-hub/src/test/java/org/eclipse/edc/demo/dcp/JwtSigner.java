        ...
        public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) {
            return Stream.of(
                    ...
                    Arguments.of(System.getProperty("user.dir") + "/../../deployment/assets/credentials/k8s/consumer/membership_vc.json",
                            ...
                            "did:web:consumer-identityhub.mvd-consumer-ctrl.svc.cluster.local%3A7083:consumer", DATASPACE_ISSUER_DID_K8S, ISSUER_DID_DOCUMENT_K8S),
                    ...
                    Arguments.of(System.getProperty("user.dir") + "/../../deployment/assets/credentials/local/consumer/unsigned/membership_vc.json",
                            ...
                            "did:web:consumer-identityhub.mvd-consumer-ctrl.svc.cluster.local%3A7083:consumer", DATASPACE_ISSUER_DID_LOCAL, ISSUER_DID_DOCUMENT_LOCAL),
